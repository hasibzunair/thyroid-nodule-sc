...
def plot_graphs_cascade(history,LOG_PATH, EXPERIMENT_NAME):
    ...
    plt.subplot(234)
    plt.plot(history.history['model_3_loss'], linewidth=4)
    plt.plot(history.history['val_model_3_loss'], linewidth=4)
    plt.title('Loss Out')
    # plt.ylabel('Loss')
    plt.xlabel('Epoch')
    plt.legend(['Train', 'Test'], loc='upper left')
    ...
    plt.subplot(235)
    plt.plot(history.history['model_3_jacard'], linewidth=4)
    plt.plot(history.history['val_model_3_jacard'], linewidth=4)
    ...
    plt.subplot(236)
    plt.plot(history.history['model_3_dice_coef'], linewidth=4)
    plt.plot(history.history['val_model_3_dice_coef'], linewidth=4)
    plt.title('Dice Out')
    # plt.ylabel('Dice')
    plt.xlabel('Epoch')
    plt.legend(['Train', 'Test'], loc='upper left')
